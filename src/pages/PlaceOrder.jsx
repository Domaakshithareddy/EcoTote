...
const PlaceOrder = () => {
  const { cart, setCart, setPurchaseOrders, sidebarCollapsed } = useContext(AppContext);
  ...
  return (
    <PageWrapper>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1px_2fr] gap-6 max-w-6xl mx-auto">
          {/* Left - Cart Summary */}
          <div>
